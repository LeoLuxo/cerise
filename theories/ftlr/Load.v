...
Section fundamental.
  ...
  Proof.
    ...
    assert (∃ p0 b0 e0 a0, read_reg_inr (<[PC:=WCap asid p b e a]> r) src p0 b0 e0 a0) as [p0 [b0 [e0 [a0 HVsrc] ] ] ].
    {
    ...
    { rewrite /allow_load_res /allow_load_mem.
      destruct (decide (reg_allows_load (<[PC:=WCap asid p b e a]> r) src p0 b0 e0 a0 ∧ a0 ≠ a)).
